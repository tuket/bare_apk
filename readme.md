...
```
C:/Android/cmdline-tools/latest/bin/sdkmanager "build-tools;34.0.0-rc3"
```

Install the latest NDK:
```
C:/Android/cmdline-tools/latest/bin/sdkmanager "ndk;25.2.9519653"
```
...
```
C:/Android/cmdline-tools/latest/bin/sdkmanager "platforms;android-21"
```
...
```
C:/Android/cmdline-tools/latest/bin/sdkmanager "platform-tools"
```
